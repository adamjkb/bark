...
export const seedOrResetDB = async () => {
	try {
		const seed_data = [
			...
			{'id': 10,	'name': 'A-E', 		'path':'0001000100010005',	'depth': 4,		'numchild': 0 },
			{'id': 11,	'name': 'B-A', 		'path':'0001000100020001',	'depth': 4,		'numchild': 0 },
			{'id': 12,	'name': 'B-B', 		'path':'0001000100020002',	'depth': 4,		'numchild': 0 },
